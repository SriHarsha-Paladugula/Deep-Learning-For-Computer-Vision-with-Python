...
class HDF5DatasetGenerator():
    def __init__(self, dbPath, batchSize, preprocessors=None, aug=None, binarize=True, classes=2):
        ...
        # store the batch size, preprocessors, and data augmentor, whether or not the labels should be binarized,
        ...
        while epochs < passes:
            ...
            for i in range(0, self.numImages, self.batchSize):
                ...
                if self.aug is not None:
                    images, labels = next(self.aug.flow(images, labels, self.batchSize))
